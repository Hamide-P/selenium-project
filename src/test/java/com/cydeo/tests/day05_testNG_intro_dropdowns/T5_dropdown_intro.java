...
public class T5_dropdown_intro {
    ...
    public void simple_dropdowns_test() {
        ...
        // Actual:
        String actualDefaultStateValue = stateDropdown.getFirstSelectedOption().getText(); // To retrieve the text of the selected option from the webElement, we use the getText() method instead of accessing the webElement itself.
