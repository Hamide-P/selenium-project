...
public class T1_Bing_Search {
    ...
    public void setupMethod() {
        ...
        driver.get(ConfigurationReader.getProperty("bingURL"));// method that can go config.use the key and get the value
    }
 ...
 /*  #old version
    ...
    public void bing_search_test() {
        ...
        WebElement cookiesAccept = driver.findElement(By.xpath("//button[@id='bnp_btn_accept']"));
        cookiesAccept.click();

        //locate the search box
        WebElement searchBox = driver.findElement(By.xpath("//textarea[@name='q']"));
        //searchBox.sendKeys("apple" + Keys.ENTER); -> hard coded version
        searchBox.sendKeys(ConfigurationReader.getProperty("searchValue") + Keys.ENTER); // searchValue is dynamic


        //4- Verify title:
        //Expected: apple - Search // normal way
