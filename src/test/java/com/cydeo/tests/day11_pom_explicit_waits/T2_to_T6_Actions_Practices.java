...
public class T2_to_T6_Actions_Practices {
    ...
    public void test6_big_circle_hovering_text_verify() {
        ...
        //  import static  org.testng.Assert.*; ==> then we hit enter, it all import statically
        assertTrue(actualBigCircleText.equals(expectedText)); // => then we can use only assertTrue without calling 'Assert' class name.
    }
