...
public class T7_T8_T9_POM_Practices {
    ...
    LibraryLoginPage loginPage; //  we declare an instance variable of type LibraryLoginPage at the class level and instantiate it beforeMethod level because we will use this in each test.Do NOT create object here!!
    ...
    public void setupMethod() {
        ...
        loginPage = new LibraryLoginPage(); // Instantiate the LibraryLoginPage object and assign it to the loginPage variable
    }
    ...
    public void t7_field_required_error_message_test() {
        ...
        loginPage.signInButton.click(); // we get 'signInButton'from LibraryLoginPage
