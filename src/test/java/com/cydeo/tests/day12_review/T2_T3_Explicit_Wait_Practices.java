...
public class T2_T3_Explicit_Wait_Practices {
    ...
    DynamicControlsPage dynamicControlsPage; // When we create an object of the class DynamicControlsPage in multiple tests, our constructor receives the current section ID from the driver. Once the constructor receives the section ID, it terminates the current section.
